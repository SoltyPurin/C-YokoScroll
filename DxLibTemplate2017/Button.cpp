...
Button::Button(ButtonJob job,int buttonImageHandle, CHAR* message,Vector2 pos):
_job(job),
...
{
	DrawExtendGraph(_startPos.x, _startPos.y, _endPos.x,_endPos.y , _buttonHandle, TRUE);
